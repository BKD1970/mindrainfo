...
description: "The requested article could not be found on MindraInfo.",
};
}
...
alternates: {
canonical: `https://mindrainfo.in/articles/${slug}`,
},
};
}
...
const articleUrl = `https://mindrainfo.in/articles/${article.slug}`;
...
articleSection: article.category || "MindraInfo",
publisher: {
"@type": "Organization",
name: "MindraInfo",
